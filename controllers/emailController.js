...
emailController.sendRegisteredMail = async function (visitorId) {
    try {
...
emailController.sendExhibitorRegisteredMail = async function (exhibitorId) {
    try {
        ...
        let info = await transporter.sendMail({
            ...
            <body>
                <h1>Welcome to NeoFairs</h1>
                <p>Thank you for registering. Approval is pending. We will get back to you soon.</p>
                <br />
                <p>If you did not request this, please ignore this email.</p>
            </body>
            </html>`,
...
<head>
    ...
    <title>Approval Process Completed</title>
    <style>
        /* General reset */
        body, table, td, a {
